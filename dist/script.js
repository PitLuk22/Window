...
/* harmony import */ var _noLetters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./noLetters */ "./src/js/modules/noLetters.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_noLetters__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_noLetters__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
...
/* harmony import */ var _noLetters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./noLetters */ "./src/js/modules/noLetters.js");
...
var forms = function forms(state) {
  ...
  Object(_noLetters__WEBPACK_IMPORTED_MODULE_6__["default"])('input[name="user_phone"]'); // Отправляем данные на сервер

  var postData = function postData(url, data, form) {
    var loadingStatusMessage, res;
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            loadingStatusMessage = document.createElement('img');
  ...
  form.forEach(function (elem) {
    elem.addEventListener('submit', function (event) {
      ...
      postData('assets/server.php', formData, elem).then(function (res) {
        console.log(res);
        ...
        clearInputs(); // elem.reset();  // очистка определнной формы
...
var images = function images() {
  ...
  workSection.addEventListener('click', function (event) {
    event.preventDefault(); //открытие большого изображения
...
var noLettersInInputs = function noLettersInInputs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (noLettersInInputs);
...
var timer = function timer(id, deadline) {
  ...
  var addZero = function addZero(num) {
    var res = num <= 9 ? num = "0".concat(num) : num;
    return res;
  };
